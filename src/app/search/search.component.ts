...
export class SearchComponent implements OnInit {
  ...
  readonly supportedExpansions = [
    { value: 'core', display: '基本セット' },
    { value: 'european', display: '欧州の翼' },
    { value: 'oceania', display: '大洋州の翼' },
    { value: 'asia', display: '東洋の翼' },
    { value: 'americas', display: 'アメリカ拡張' },
  ]

  readonly assetPacks = [
    { value: 'silhouette', display: 'シルエット' },
    { value: 'robbie', display: "Robbie's birds" },
    { value: 'diffusion', display: 'イラスト画像' }
  ]
